...
const DigitalTransformation = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Upgrade outdated systems with modern, scalable solutions.',
    },
    {
    ...
    },
    {
      ...
      description: 'Transform customer journeys with digital innovations.',
    },
  ];
  ...
  return (
    <>
      <SEO
        ...
        description="Drive business growth with comprehensive digital transformation strategies and solutions."
        keywords="digital transformation, business automation, modernization, data analytics"
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-sky-50 via-cyan-50 to-blue-50 overflow-hidden">
        ...
        <div className="container-custom relative z-10 py-20 text-center">
          ...
          <p className="text-base md:text-xl lg:text-2xl text-gray-600 max-w-3xl mx-auto mb-6 md:mb-8 animate-fadeInUp animate-delay-200">
            Transform your business for the digital age with strategic innovation
          </p>
          <Link to="/contact">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-gray-800">Transformation Services</h2>
      ...
      <section className="section-padding bg-gradient-to-r from-cyan-600 via-blue-600 to-sky-600 text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl mb-8 text-cyan-50 max-w-2xl mx-auto">
            Let's work together to transform your business for the digital future
          </p>
          <Link to="/contact">
