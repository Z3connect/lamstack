  ...
  const services = [
    {
      ...
      description: 'Native iOS apps using Swift and cutting-edge Apple technologies.',
    },
    {
      title: 'Android Development',
      description: 'High-performance Android apps with modern development practices.',
    },
    {
      title: 'Cross-Platform Apps',
      description: 'React Native and Flutter apps for both platforms.',
    },
    {
  ...
  return (
    <>
      <SEO
        ...
        description="Expert mobile app development for iOS and Android using React Native, Flutter, and native technologies."
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-sky-50 via-cyan-50 to-blue-50 overflow-hidden">
        ...
        <div className="container-custom relative z-10 py-20 text-center">
          ...
          <p className="text-base md:text-xl lg:text-2xl text-gray-600 max-w-3xl mx-auto mb-6 md:mb-8 animate-fadeInUp animate-delay-200">
            Build exceptional mobile experiences with 10+ years of expertise
          </p>
          <Link to="/contact">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-gray-800">Our Mobile Services</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Full-stack mobile development from concept to launch
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-4 md:gap-8">
            {services.map((service, index) => (
              ...
              >
                <div className="mb-3 md:mb-6 transform group-hover:scale-110 transition-transform">
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-white/80 border border-cyan-200 flex items-center justify-center">
      ...
      <section className="section-padding bg-gradient-to-r from-cyan-600 via-blue-600 to-sky-600 text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl mb-8 text-cyan-50 max-w-2xl mx-auto">
            Let's bring your mobile app vision to life with our expert team
          </p>
          <Link to="/contact">
