...
const Header = () => {
  ...
  const services = [
    { key: 'recruitment', label: 'Recruitment (Main)', path: '/employers', highlight: true },
    { key: 'devops', label: 'DevOps', path: '/services/devops' },
    { key: 'consulting', label: 'IT Consulting', path: '/services/consulting' },
    { key: 'mobile', label: 'Mobile App Development', path: '/services/mobile' },
    { key: 'transformation', label: 'Digital Transformation', path: '/services/transformation' },
  ];

  const renderIcon = (key) => <ServiceIcon name={key} className="h-4 w-4 text-white/90" />;
  ...
  return (
    <header className={`sticky top-0 z-50 transition-all duration-500 ${
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-1.5">
            ...
            >
              ...
              >
                {/* Dropdown arrow */}
                <div className="absolute -top-2 right-8 w-4 h-4 bg-black rotate-45 border-t border-l border-white/10"></div>
                      ...
                      >
                        <div className="relative z-10 flex items-center justify-between">
                          <span className="flex items-center space-x-3">
                            <span className="flex items-center justify-center w-6 h-6 rounded-lg bg-white/5 text-white/90">
                              {renderIcon(service.key)}
                            </span>
                            <span className="text-sm lg:text-base">{service.label}</span>
                          </span>
                        ...
                        {service.highlight && (
                          <div className="mt-1 text-xs text-gray-300 opacity-90 flex items-center gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2L3 14h7l-1 8 10-12h-7l1-8Z"/></svg>
      ...
      >
        <div className="relative bg-black border-t border-white/10 shadow-2xl">
          {/* Background glow */}
          ...
          <nav className="container-custom py-8 space-y-2 relative z-10">
            {navLinks.map((link, index) => (
              ...
              >
                ...
                <span className="absolute inset-0 border border-white/10 rounded-xl transition-all duration-300"></span>
                ...
                <div className="ml-4 space-y-2 border-l border-white/10 pl-4">
                  {services.map((service, index) => (
                    ...
                    >
                      ...
                      {service.highlight && (
                        <div className="mt-1 text-xs text-gray-300 opacity-90 relative z-10 flex items-center gap-1">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2L3 14h7l-1 8 10-12h-7l1-8Z"/></svg>
                          Most Popular
                        </div>
                      )}
