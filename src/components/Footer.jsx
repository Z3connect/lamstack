...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-base-card text-white overflow-hidden border-t border-white/10">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <div className="absolute top-0 left-0 w-96 h-96 bg-primary-start rounded-full filter blur-[100px] animate-pulse"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-accent-purple rounded-full filter blur-[100px] animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="container-custom py-12 md:py-16 lg:py-20 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-4 md:space-y-6">
            ...
            <div className="flex space-x-3 md:space-x-4">
              <a
                ...
                className="group w-10 h-10 md:w-12 md:h-12 bg-white/5 hover:bg-gradient-to-r hover:from-primary-start hover:to-accent-blue rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-primary-start/30"
                aria-label="LinkedIn"
              >
            ...
            <ul className="space-y-2 md:space-y-3">
              {quickLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-gray-400 hover:text-primary-start hover:translate-x-2 inline-block transition-all duration-200 group text-sm md:text-base"
                  >
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg md:text-xl font-bold mb-4 md:mb-6 text-white">Services</h3>
            <ul className="space-y-2 md:space-y-3">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-3 md:space-y-4">
              <li className="flex items-start space-x-3">
                <svg className="w-4 h-4 md:w-5 md:h-5 text-primary-start mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@lamstacks.com" className="text-gray-400 hover:text-white transition-colors text-sm md:text-base break-all">
                  info@lamstacks.com
                </a>
              </li>
              <li className="flex items-start space-x-3">
